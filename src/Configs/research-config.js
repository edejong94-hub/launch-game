  ...
  expertRoles: {
    ...
    customer: {
      ...
      contracts: [
        ...
        { id: "loi", name: "Letter of Intent (LOI)", description: "Customer commitment — only after 3+ quality interviews" },
...
lowRunwayWarning: {
  ...
  activities: {
    ...
    customerValidation: {
      ...
      costMoney: 0,
      category: "discovery",
      description: "Get a Letter of Intent from a real customer. Requires 3+ interviews. Business Developer confirms evidence quality.",
      requiresInterviews: 3,
      requiresContract: "loi",
      expert: "customer",
      triggersEvent: "customerValidationSuccess",
      hint: "The Business Developer will only give an LOI if your interviews are solid. Come with evidence, not enthusiasm.",
    },
    industryExploration: {
